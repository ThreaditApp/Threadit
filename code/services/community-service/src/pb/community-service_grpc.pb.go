...
const (
	...
	CommunityService_UploadCommunityIcon_FullMethodName  = "/community.CommunityService/UploadCommunityIcon"
	CommunityService_JoinCommunity_FullMethodName        = "/community.CommunityService/JoinCommunity"
	CommunityService_LeaveCommunity_FullMethodName       = "/community.CommunityService/LeaveCommunity"
...
type CommunityServiceClient interface {
	...
	UploadCommunityIcon(ctx context.Context, in *UploadCommunityIconRequest, opts ...grpc.CallOption) (*Community, error)
	JoinCommunity(ctx context.Context, in *JoinCommunityRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	LeaveCommunity(ctx context.Context, in *LeaveCommunityRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *communityServiceClient) UploadCommunityIcon(ctx context.Context, in *UploadCommunityIconRequest, opts ...grpc.CallOption) (*Community, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Community)
	err := c.cc.Invoke(ctx, CommunityService_UploadCommunityIcon_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *communityServiceClient) JoinCommunity(ctx context.Context, in *JoinCommunityRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *communityServiceClient) LeaveCommunity(ctx context.Context, in *LeaveCommunityRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type CommunityServiceServer interface {
	...
	UploadCommunityIcon(context.Context, *UploadCommunityIconRequest) (*Community, error)
	JoinCommunity(context.Context, *JoinCommunityRequest) (*emptypb.Empty, error)
	LeaveCommunity(context.Context, *LeaveCommunityRequest) (*emptypb.Empty, error)
...
func (UnimplementedCommunityServiceServer) UploadCommunityIcon(context.Context, *UploadCommunityIconRequest) (*Community, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UploadCommunityIcon not implemented")
}
func (UnimplementedCommunityServiceServer) JoinCommunity(context.Context, *JoinCommunityRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method JoinCommunity not implemented")
}
func (UnimplementedCommunityServiceServer) LeaveCommunity(context.Context, *LeaveCommunityRequest) (*emptypb.Empty, error) {
...
func _CommunityService_UploadCommunityIcon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UploadCommunityIconRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommunityServiceServer).UploadCommunityIcon(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommunityService_UploadCommunityIcon_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommunityServiceServer).UploadCommunityIcon(ctx, req.(*UploadCommunityIconRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommunityService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UploadCommunityIcon",
			Handler:    _CommunityService_UploadCommunityIcon_Handler,
		},
		{
