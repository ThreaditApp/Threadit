...
const file_db_service_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id2\xec\a\n" +
	"\tDBService\x12J\n" +
	...
	"\rCreateComment\x12\x18.db.CreateCommentRequest\x1a\x19.db.CreateCommentResponse\x126\n" +
	"\n" +
	"GetComment\x12\x15.db.GetCommentRequest\x1a\x11.models.Community\x12A\n" +
...
var file_db_service_proto_depIdxs = []int32{
	...
	21, // 31: db.DBService.GetComment:output_type -> models.Community
